...
for i in range(100):#閲覧回数の日程を編集に持ってくる
    sum_views=0
...
with open(r'c:/Users/KoyanagiKazuya/Desktop/11-29-1/sample_writer_row.csv', 'w', newline="") as f:
    writer = csv.writer(f)
...
with open(r'c:/Users/KoyanagiKazuya/Desktop/11-29-1/sample_writer_row.csv') as f:
    print(f.read())
...
#CSVファイル内に書き込み
with open(r'c:/Users/KoyanagiKazuya/Desktop/11-29-1/sample_writer_row2.csv', 'w', newline="") as f:
    writer = csv.writer(f)
...
with open(r'c:/Users/KoyanagiKazuya/Desktop/11-29-1/sample_writer_row2.csv') as f:
    print(f.read())
