...
with open(r'c:/Users/KoyanagiKazuya/Desktop/12-6/sample_writer_row4.csv', 'w', newline="") as f:
    writer = csv.writer(f)
...
with open(r'c:/Users/KoyanagiKazuya/Desktop/12-6/sample_writer_row4.csv') as f:
    print(f.read())