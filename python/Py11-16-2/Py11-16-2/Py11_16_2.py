...
ny2 =wikipedia.page("Wikipedia:秀逸な記事")
re_ny=ny2.links
...
num=95
for i in range(94):#閲覧回数の日程を編集に持ってくる
    sum_views=0
...
with open(r'c:/Users/KoyanagiKazuya/Desktop/11-29-1/sample_writer_row5.csv', 'w', newline="") as f:
    writer = csv.writer(f)
    ...
    for item in range(num):
       print(item)
       writer.writerow(['2',result_ran_view[item] ,result_ran_edit[item] ,result_ran_nofitem[item] ,result_ran_texnum[item],result_ran_isbns[item],result_ran_urls[item]   ])

with open(r'c:/Users/KoyanagiKazuya/Desktop/11-29-1/sample_writer_row5.csv') as f:
    print(f.read())
