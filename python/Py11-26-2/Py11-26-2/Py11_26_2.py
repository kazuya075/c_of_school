...
#CSVファイル内に書き込み
with open(r'c:/Users/KoyanagiKazuya/Desktop/12-7/sample_writer_row2.csv', 'w', newline="") as f:
    writer = csv.writer(f)
...
with open(r'c:/Users/KoyanagiKazuya/Desktop/12-7/sample_writer_row2.csv') as f:
    print(f.read())
