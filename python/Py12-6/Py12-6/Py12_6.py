...
with open(r'c:/Users/KoyanagiKazuya/Desktop/12-6/sample_writer_row11.csv', 'w', newline="") as f:
    writer = csv.writer(f)

    writer.writerow(['point',"view","edit","NofItem","TexNum","isbn","url"])

    for item in range(num):#これだと499
       print(item)
...
with open(r'c:/Users/KoyanagiKazuya/Desktop/12-6/sample_writer_row11.csv') as f:
    print(f.read())